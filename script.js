...
$(document).ready(function () {
    ...
    for(let i=1;i<=100;i++){
        ...
        for(let j=1;j<=100;j++){
            ...
            let col = $(`<div class="input-cell" id="row-${i}-col-${j}" data="code-${colCode}"></div>`);
            row.append(col);
        }
    ...
    function changeHeader(ele){
        ...
        cellInfo["font-decoration"] ? $(".icon-underlline").addClass("selected") : $(".icon-underline").removeClass("selected");
...
$(".icon-align-justify").click(function(){
    if(!$(this).hasClass("selected")){
        updateCell("text-align","justify",false);
    }
});